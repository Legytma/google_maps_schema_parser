...
class GoogleMapSchemaWidgetParser extends SchemaWidgetParser<GoogleMap> {
  ...
  GoogleMap builder(BuildContext buildContext, Map<String, dynamic> value,
    ...
    return GoogleMap(
      ...
      padding: SchemaWidget.parse<EdgeInsets>(
          buildContext, value['padding'], const EdgeInsets.all(0)),
      ...
      cameraTargetBounds: SchemaWidget.parse<CameraTargetBounds>(buildContext,
          value['cameraTargetBounds'], CameraTargetBounds.unbounded),
      ...
      liteModeEnabled: value['liteModeEnabled'] ?? false,
    );
  }
}
